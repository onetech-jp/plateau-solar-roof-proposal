...
- 塗装概算(PLATEAU のみ): 足場 (外周+8m)×(軒高+0.7m)×単価、屋根面積=建築面積×勾配係数(勾配は選択)×屋根材単価、外周×軒高×(1−開口率)×塗料単価、洗浄・付帯・諸経費
...
## Google Solar API の利用規約への対応(2026-09-20 確認・重要)

Google Maps Platform サービス固有規約 20 条(Solar API)に従う。
